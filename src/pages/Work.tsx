...
const cards: ProjectCard[] = [
  {
    ...
    shortDesc:
      "Built to enable solar sales. Includes user management, CAD drawing overlays, Google Maps, NearMap, and Google Geocoding APIs, Financing API integrations with multiple lenders, and DocuSign integrated flow. Contact me if you're interested in seeing the site in action!",
    techStack: [
      materialUI48,
      javascript48,
      react48,
  ...
  },
  {
    ...
    shortDesc:
      'A tool for reporting illicit discharges to the Albemarle County Service Authority.',
  ...
  },
  {
    ...
    name: 'Pomodoro V2',
    shortDesc:
      'A simple Pomodoro timer built with React and Material-UI. Use it to stay focused and productive! ',
  ...
  },
  {
    ...
    name: 'Noteful',
    shortDesc:
      'A persistent note-taking app with folders for note organization.',
  ...
  },
  {
    ...
    shortDesc:
      'A simple jQuery + CSS quiz site to help you learn the Unix shell.',
